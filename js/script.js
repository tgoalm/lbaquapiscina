		...
		var regularConstraintsMessages = [
			{
				...
				newMessage: "Por favor, preencha este campo."
			},
			{
				type: regula.Constraint.Email,
				newMessage: "Este não é um endereço de e-mail válido."
			},
			{
				type: regula.Constraint.Numeric,
				newMessage: "Por favor, preencha seu telefone apenas com números."
			},
			{
